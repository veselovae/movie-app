...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.li, __VLS_intrinsicElements.li)(Object.assign({ class: ("navigation-item") }));
    var __VLS_0 = {};
    if (typeof __VLS_styleScopedClasses === 'object' && !Array.isArray(__VLS_styleScopedClasses)) {
        __VLS_styleScopedClasses['navigation-item'];
    }
    var __VLS_slots;
    return __VLS_slots;
